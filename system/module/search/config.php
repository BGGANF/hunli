...
$config->search->fields = new stdclass();
$config->search->fields->guests = new stdclass();
$config->search->fields->guests->id         = 'id';
$config->search->fields->guests->title      = 'name';
$config->search->fields->guests->mobile     = 'mobile';
$config->search->fields->guests->addedDate  = 'addedDate';
$config->search->fields->guests->editedDate = 'editedDate';
