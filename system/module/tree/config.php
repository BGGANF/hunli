...
$config->tree->menuGroups->express = 'guests';

$config->tree->editableTypes = ",article,product,blog,forum,guests,";
...
$config->tree->systemModules .= 'nav,product,rss,site,slide,thread,ui,user,article,blog,cache,guests,';
